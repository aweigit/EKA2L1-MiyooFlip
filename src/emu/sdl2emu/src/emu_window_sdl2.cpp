...
namespace eka2l1 {
    namespace drivers {
        ...
        bool emu_window_sdl2::set_cursor(cursor *cur) {
            return false;
        }
        ...
        void emu_window_sdl2::change_title(std::string new_title) {
        }

        void emu_window_sdl2::make_current() {
        }

        void emu_window_sdl2::done_current() {
        }
        ...
        void emu_window_sdl2::set_userdata(void *new_userdata) {
        ...
        void emu_window_sdl2::surface_changed(void *surf, int width, int height) {
            if ((width > 0) && (height > 0)) {
                fb_size.x = width;
                fb_size.y = height;
            }
