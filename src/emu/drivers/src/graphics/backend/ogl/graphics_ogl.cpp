...
namespace eka2l1::drivers {
    ...
    ogl_graphics_driver::ogl_graphics_driver(const window_system_info &info)
        ...
        printf("major_gl:%d minor_gl:%d\n",major_gl,minor_gl);

        printf("ogl_graphics_driver3\n");
    ...
    void ogl_graphics_driver::update_surface(void *new_surface_set) {
        LOG_INFO(DRIVER_GRAPHICS, "ogl_graphics_driver::update_surface");
